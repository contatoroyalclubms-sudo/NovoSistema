...
try:
    ...
    app.include_router(refunds.router, prefix=f"{API_PREFIX}")
    logger.info("✓ Router de Refunds carregado com sucesso")
except ImportError as e:
    logger.warning(f"Router de Refunds não encontrado: {e}")
except Exception as e:
    logger.error(f"Erro ao carregar router de Refunds: {e}")
